...
func (app *application) render(w http.ResponseWriter, r *http.Request, t string, dt *TemplateData) error {
...
func (app *application) Login(w http.ResponseWriter, r *http.Request) {
	...
	log.Println(password, email, user.FirstName)
